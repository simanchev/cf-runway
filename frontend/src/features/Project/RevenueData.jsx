        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form className="modal-form" onSubmit={console.log(10)}>
                <div className="mb-3">
                ...
                <div className="mb-3 modal-flex">
                  ...
                  <div>
                    ...
                    <select className="form-select">
                      <option value="true" selected>Eжемесячно</option>
                ...
                <div className="mb-3 modal-flex">
                  <div>
                    <label className="form-label">Месяц старта</label>
            ...
            <div className="modal-footer">
              <button type="button" className="btn btn-dark btn-modal">Добавить</button>
            </div>
          </div>
        </div>
      </div>
