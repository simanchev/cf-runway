    ...
    <div className="fin-data-wrap">
      <div className="fin-data">
        <table className="table">
          ...
          <tbody>
            {revenueData.map((data) => <RevenueDataItem data={data} key={data.id} />)}
          </tbody>
        </table>
        <button type="button" className="btn btn-outline-dark btn-add" onClick={loadModal} data-bs-toggle="modal" data-bs-target="#finDataModal">
