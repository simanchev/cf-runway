...
function ModalInvestmentItem() {
  ...
  return (
    <div className="modal fade" id="modalInvestmentItem" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">
              {finData.id ? 'Изменить текущую операцию' : 'Добавить новые инвестиции'}
            </h5>
...
export default ModalInvestmentItem;
